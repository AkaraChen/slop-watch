...
const en: Record<UiKey, string> = {
	...
	siteTagline: 'AI Slop catalog with receipts for incidents and CVEs',
	siteDescription:
		'Public landfill of AI products that ship hard, break harder, and leave CVEs, open-issue swamps, and vibe-coded wreckage. Named specimens with links, reasons, and public receipts.',
	navCatalog: 'Catalog',
	navAbout: 'About',
	...
	aboutTitle: 'About Slop Watch: the AI Slop catalog with receipts',
	aboutMetaDescription:
		'What Slop Watch is and why “slop” here means quality trash with public receipts — not a promo reel or endorsement archive for AI products.',
	aboutP1:
	...
	standardsTitle: 'Inclusion standards · How Slop Watch picks AI Slop',
	standardsMetaDescription:
		'How Slop Watch chooses AI Slop specimens: public evidence of quality collapse, incidents, and security debt — not hype, stars, or endorsement.',
	...
	specimenTitle: '{name} · AI Slop specimen on the Slop Watch catalog',
	language: 'Language',
...
const zh: Record<UiKey, string> = {
	siteTitle: 'Slop Watch',
	siteTagline: 'AI 垃圾档案：质量崩坏、线上事故与 CVE，件件附带公开可核验收据。',
	siteDescription:
		'公开的 AI 产品垃圾填埋场：猛推上线、猛烈崩溃，留下 CVE、issue 堰塞湖与 vibe coding 残骸。我们为每件标本保留名称、主链接、入选理由，以及可核验的公开参考资料，方便读者对照证据、看清质量失控与事故连发的模式，而不是只看宣传口径。',
	navCatalog: '目录',
	navAbout: '关于',
	navStandards: '收录标准',
	...
	aboutTitle: '关于 · Slop Watch 公开档案：AI 垃圾标本、质量崩坏、线上事故与收录背景的完整说明',
	aboutMetaDescription:
		'说明 《Slop Watch》是什么，以及这里的 slop 为何是「有证据的质量垃圾」：聚焦质量崩坏、线上事故与 CVE，用公开收据说明问题，帮助读者对照证据、看清质量失控与事故连发的模式，而不是安利合集、星标冲榜、病毒传播话术或软性展示。',
	aboutP1:
	...
	standardsTitle: '收录标准 · 公开档案 Slop Watch 如何挑选 AI 垃圾标本及所需公开可核验证据的条件',
	standardsMetaDescription:
		'说明 《Slop Watch》如何选择 AI 垃圾标本：只看公开可核验的质量崩坏、线上事故与安全债证据，而不是热度、星标数量、病毒传播数据或安利式宣传内容的简单堆砌；公开痕迹太薄、无法核验的条目不会进入本目录的收录范围，读者可据此判断标准。',
	standardsH1: '收录标准',
	standardsP1:
	...
	specimenTitle: '{name} · AI 垃圾标本条目 · 收录于 Slop Watch 公开档案',
	language: '语言',
	hardSignals: '硬信号',
